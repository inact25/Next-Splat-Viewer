                ...
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <div className="mt-12 flex flex-wrap justify-center gap-4 ">
                        ...
                        >
                            ...
                            />
                            <span
                                className="absolute start-3 top-3 -translate-y-1/2 text-xs text-gray-700 dark:text-white transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-sm peer-focus:top-3 peer-focus:text-xs"
                            >
    World Source (.splat)
  </span>
                        </label>
