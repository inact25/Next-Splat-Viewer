...
export default function GaussianSplat({
  ...
  return (
    <>
      {isLoading && (
        <div
          className={`${className} min-h-[100dvh] absolute z-9999 w-full flex justify-center items-center bg-[#233736]`}
        >
          <div>
            {!!thumbnail?.length ? (
              <img
            ...
            <div
              role="status"
              className="text-center flex justify-center gap-5 items-center text-[#98b8a7]"
            >
              <svg
                aria-hidden="true"
